...
file_path = "input\hcpc_text_oct2025.txt"
...
hcpc = pd.read_fwf(file_path, colspecs=colspecs, names=column_names)
hcpc_small = hcpc[["Code", "Description2"]].copy()
hcpc_small = hcpc_small.rename(columns={"Code": "code", "Description2": "description"})
hcpc_small["last_updated"] = "09-18-2025"

## save as csv to Module1_MedicalCodexes/hcpcs/output
output_path = "output/hcpcs_small.csv"
hcpc_small.to_csv(output_path, index=False)